...
export class ElectronIntroUseCase extends BaseUseCase {
  ...
  registerHandlers(): void {
    ...
    this.ipcMain.handle(
      'electron-intro:get-data',
      async (_event: Electron.IpcMainInvokeEvent, _params: unknown): Promise<ElectronIntroData> => {
        return {
