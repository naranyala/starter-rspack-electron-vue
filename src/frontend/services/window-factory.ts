  ...
  static createWindow(
    ...
    setTimeout(() => {
      ...
      if (winboxRoot) {
        ...
        if (closeBtn) {
          closeBtn.innerHTML = `<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="square"><line x1="6" y1="6" x2="18" y2="18"></line><line x1="18" y1="6" x2="6" y2="18"></line></svg>`;
        }

        // Maximize button - square icon
        const maxBtn = (winboxRoot as HTMLElement).querySelector('.wb-max');
        if (maxBtn) {
          maxBtn.innerHTML = `<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="square"><rect x="4" y="4" width="16" height="16"></rect></svg>`;
        }

        // Minimize button - minus icon
        const minBtn = (winboxRoot as HTMLElement).querySelector('.wb-min');
        if (minBtn) {
          minBtn.innerHTML = `<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="square"><line x1="5" y1="12" x2="19" y2="12"></line></svg>`;
        }

        // Fullscreen button - expand icon
        const fullBtn = (winboxRoot as HTMLElement).querySelector('.wb-full');
        if (fullBtn) {
          fullBtn.innerHTML = `<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="square"><polyline points="15 3 21 3 21 9"></polyline><polyline points="9 21 3 21 3 15"></polyline><line x1="21" y1="3" x2="14" y2="10"></line><line x1="3" y1="21" x2="10" y2="14"></line></svg>`;
        }
      }
    }, 50);
